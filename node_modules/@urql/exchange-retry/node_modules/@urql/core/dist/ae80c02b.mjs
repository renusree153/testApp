...
var stringifyDocument = r => {
  var e = (r => r.split(s).map(replaceOutsideStrings).join("").trim())("string" == typeof r ? r : r.loc && "gql" === r.loc.source.name ? r.loc.source.body : t(r));
...
//# sourceMappingURL=ae80c02b.mjs.map

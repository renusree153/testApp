...
var stringifyDocument = node => {
  var printed = sanitizeDocument(typeof node === 'string' ? node : node.loc && node.loc.source.name === SOURCE_NAME ? node.loc.source.body : graphql.print(node));
...
//# sourceMappingURL=443c35ce.js.map

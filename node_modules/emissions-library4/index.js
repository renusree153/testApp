...
function LocationFinderComponent () {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (Platform.OS === 'ios') {
        ...
        // ex of phoneId is 7F68C24D-FA7D-4B76-8B1C-0DC74FDBD15C -> string 
        .then(value => {
          storePhoneId = value;
        })
      }
      ...
      async function updateLocation () {
        ...
        // then the array will be emptied 
            ...
            create(dataPlanArray[0], storePhoneId, devName, phoneModel, phoneOs);
            console.log(dataPlanArray[0]);
            dataPlanArray.shift();
        }
        else {
          create(acquired_location, storePhoneId, devName, phoneModel, phoneOs);
  ...
  const create = (acquired_location, storePhoneId, devName, phoneModel, phoneOs) => {
